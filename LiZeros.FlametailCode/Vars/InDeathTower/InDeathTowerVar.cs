...
{
    public class InDeathTowerVar : BoolVar
    {
        public const string NAME = "InDeathTower";

        public InDeathTowerVar() : base(NAME)
        {
        }
        ...
        public decimal GetAmount()
        {
            ...
            if (creature != null && creature.HasPower<DeathTowerPower>())
                return Convert.ToDecimal(true);
            return Convert.ToDecimal(false);
        }
